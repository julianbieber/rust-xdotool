...
/// ]);
/// ```
pub fn send_key(keys: &str, options: OptionVec<KeyboardOption>, display: u32) -> Output {
...
pub fn send_key_down(keys: &str, options: OptionVec<KeyboardOption>, display: u32) -> Output {
...
pub fn send_key_up(keys: &str, options: OptionVec<KeyboardOption>, display: u32) -> Output {
...
pub fn type_text(text: &str, options: OptionVec<KeyboardOption>, display: u32) -> Output {
