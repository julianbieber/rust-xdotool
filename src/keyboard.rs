...
impl XServer {
    ...
    /// ]);
    /// ```
    pub fn send_key(&self, keys: &str, options: OptionVec<KeyboardOption>) -> Output {
    ...
    pub fn send_key_down(&self, keys: &str, options: OptionVec<KeyboardOption>) -> Output {
    ...
    pub fn send_key_up(&self, keys: &str, options: OptionVec<KeyboardOption>) -> Output {
    ...
    pub fn type_text(&self, text: &str, options: OptionVec<KeyboardOption>) -> Output {
