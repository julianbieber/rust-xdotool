...
impl XServer {
    ...
    /// ```
    pub fn search(&self, s: &str, options: OptionVec<SearchOption>) -> Output {
    ...
    pub fn get_window_pid(&self, window: &str) -> Output {
    ...
    pub fn get_window_name(&self, window: &str) -> Output {
    ...
    pub fn get_window_focus(&self, window: &str) -> Output {
    ...
    pub fn focus_window(&self, window: &str, options: OptionVec<SyncOption>) -> Output {
    ...
    pub fn window_map(&self, window: &str, options: OptionVec<SyncOption>) -> Output {
    ...
    pub fn minimize_window(&self, window: &str, options: OptionVec<SyncOption>) -> Output {
    ...
    pub fn raise_window(&self, window: &str) -> Output {
    ...
    pub fn reparent_window(&self, source_window: &str, destination_window: &str) -> Output {
        let c = Command::Window(sub_commands::Window::WindowRaise);
    ...
    pub fn close_window(&self, window: &str) -> Output {
    ...
    pub fn kill_window(&self, window: &str) -> Output {
    ...
    pub fn unmap_window(&self, window: &str, options: OptionVec<SyncOption>) -> Output {
    ...
    ///
    pub fn set_window(&self, window: &str, options: OptionVec<SetWindowOption>) -> Output {
