...
/// ```
pub fn search(s: &str, options: OptionVec<SearchOption>, display: u32) -> Output {
...
pub fn get_window_pid(window: &str, display: u32) -> Output {
...
pub fn get_window_name(window: &str, display: u32) -> Output {
...
pub fn get_window_geometry(
    window: &str,
    options: OptionVec<GetWindowGeometryOption>,
    display: u32,
) -> Output {
...
pub fn get_window_focus(window: &str, display: u32) -> Output {
...
pub fn move_window(
    ...
    x: &str,
    y: &str,
    options: OptionVec<WindowMoveOption>,
    display: u32,
) -> Output {
...
pub fn focus_window(window: &str, options: OptionVec<SyncOption>, display: u32) -> Output {
...
pub fn window_map(window: &str, options: OptionVec<SyncOption>, display: u32) -> Output {
...
pub fn minimize_window(window: &str, options: OptionVec<SyncOption>, display: u32) -> Output {
...
pub fn raise_window(window: &str, display: u32) -> Output {
...
pub fn reparent_window(source_window: &str, destination_window: &str, display: u32) -> Output {
    let c = Command::Window(sub_commands::Window::WindowRaise);
...
pub fn close_window(window: &str, display: u32) -> Output {
...
pub fn kill_window(window: &str, display: u32) -> Output {
...
pub fn unmap_window(window: &str, options: OptionVec<SyncOption>, display: u32) -> Output {
...
///
pub fn set_window(window: &str, options: OptionVec<SetWindowOption>, display: u32) -> Output {
